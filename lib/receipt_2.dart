...
import 'transaction_loading_2.dart';

class Receipt2 extends StatefulWidget {
  const Receipt2({super.key});

  @override
  State<Receipt2> createState() => _Receipt2State();
}
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 15),
                    Text('Click on delivered for successful delivery and rate rider or\nreport missing item',
                      style: TextStyle(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => TransactionLoadingPage2())
                              );},
                            child: Text(
                              'Successful',
                              style: TextStyle(
